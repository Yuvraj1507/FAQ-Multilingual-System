...
SECRET_KEY = 'django-insecure-*^-fx!9ydj6+f+zvhm+qy^7#%$8fd=h5ixzvyzisqa2u($+*v9'
...
INSTALLED_APPS = [
    ...
    'ckeditor',        # CKEditor for WYSIWYG editor
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbarCanCollapse': True,  # Allows the toolbar to collapse
    },
}
REST_FRAMEWORK = {
